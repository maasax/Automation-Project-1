...
describe('This is first test suite, Maarit Paara', () => {
    it('User can submit data only when valid mandatory values are added', () => {
        //22.04.2024
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('#firstName').type('Maarit')
        cy.get('#lastName').type('Paara')
        cy.get('input[name="password"]').type('PasswordABC')
        cy.get('[name="confirm"]').type('PasswordABC')
